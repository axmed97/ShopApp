...
namespace ShopApp
{
    public partial class Dashboard : Form
    {
        ...
        private void FillCategoryComboBox()
        {
            ...
            cmbCategory.Items.AddRange(_context.Marka_to_Category
                .Where(x => x.Marka.Marka_Name.Contains(marka))
                .Select(x => x.Category.Category_Name).Distinct().ToArray());
        }
        private void FillMarkaComboBox()
        {
            string category = cmbCategory.Text;
            cmbMarka.Items.AddRange(_context.Marka_to_Category
                .Where(x => x.Category.Category_Name.Contains(category))
                .Select(x => x.Marka.Marka_Name).Distinct().ToArray());
        }
        ...
        {
            dtgProduct.DataSource = _context.Orders
                .Where(x => x.WorkerId == _activeWorker.Id)
                .Select(x => new
                {
        ...
        private void cmbCategory_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            FillMarkaComboBox();
            cmbProduct.Items.AddRange(_context.Products
                .Where(x => x.Category.Category_Name.Contains(category) && x.Marka.Marka_Name.Contains(marka))
                .Select(x => x.Product_Name).ToArray());
        }
        ...
        private void cmbMarka_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //FillCategoryComboBox();
            cmbProduct.Items.AddRange(_context.Products
                .Where(x => x.Marka.Marka_Name.Contains(marka) && x.Category.Category_Name.Contains(category))
                .Select(x => x.Product_Name).ToArray());
        }
